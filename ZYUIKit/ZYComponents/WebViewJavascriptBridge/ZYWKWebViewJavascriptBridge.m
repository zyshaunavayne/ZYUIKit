//
//  ZYWKWebViewJavascriptBridge.m
//  ZYUIKit
//
//  Created by 张宇 on 2023/2/8.
//

#import "ZYWKWebViewJavascriptBridge.h"

#if defined supportsWKWebView

@implementation ZYWKWebViewJavascriptBridge {
    __weak WKWebView* _webView;
    __weak id<WKNavigationDelegate> _webViewDelegate;
    long _uniqueId;
    ZYWebViewJavascriptBridgeBase *_base;
}

/* API
 *****/

+ (void)enableLogging { [ZYWebViewJavascriptBridgeBase enableLogging]; }

+ (instancetype)bridgeForWebView:(WKWebView*)webView {
    ZYWKWebViewJavascriptBridge* bridge = [[self alloc] init];
...
- (void) _setupInstance:(WKWebView*)webView {
    ...
    _base = [[ZYWebViewJavascriptBridgeBase alloc] init];
    _base.delegate = self;
}
